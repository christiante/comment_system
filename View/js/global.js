$(document).ready(function () {
	...
	$("a#reply").one("click", function () {
		...
		parent.append("<br /><form action='' method='post'><textarea class='form-control' name='new-reply' id='new-reply' required='required'></textarea><input type='hidden' name='code' value='" + comCode + "' /><input type='submit' class='btn btn-default' id='form-reply' name='new_reply' value='Reply' /></form>")
	});
